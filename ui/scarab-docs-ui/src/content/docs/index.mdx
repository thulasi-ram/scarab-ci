...
hero:
  ...
  image:
    # Filled by <AsciiScene slotSelector> below — the baked wing-spread loop.
    html: '<div class="ascii-hero-slot"></div>'
  actions:
    - text: Run it locally
...
<AsciiScene
  name="wingspread-hero"
  fontSize={9}
  slotSelector=".ascii-hero-slot"
  label="The Scarab emblem in ASCII art — a scarab spreading its wings inside its nimbus"
/>
