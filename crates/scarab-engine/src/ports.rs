...
pub trait Db: Send + Sync {
    ...
    ///
    /// (There used to be a third coordinate, `durability` — ADR-0064 s2's
    /// per-attempt tier stamp. ADR-0067 part 4 made every successful drain
    /// durable by construction, so the stamp became a constant and the column
    /// was dropped rather than kept as ceremony.)
